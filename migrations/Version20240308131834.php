 ...
 */
final class Version20240308131834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE groupesRessources (idRessource INT NOT NULL, idGroupe INT NOT NULL, INDEX IDX_9B81C0086F756E12 (idRessource), INDEX IDX_9B81C00867A824BB (idGroupe), PRIMARY KEY(idRessource, idGroupe)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE groupesUtilisateurs (idUtilisateur INT NOT NULL, idGroupe INT NOT NULL, INDEX IDX_68C4EF995D419CCB (idUtilisateur), INDEX IDX_68C4EF9967A824BB (idGroupe), PRIMARY KEY(idUtilisateur, idGroupe)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ressources (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, contenu VARCHAR(255) NOT NULL, dateCreation DATETIME NOT NULL, estPubliee TINYINT(1) DEFAULT 0 NOT NULL, estValidee TINYINT(1) DEFAULT 0 NOT NULL, estRestreinte TINYINT(1) DEFAULT 0 NOT NULL, estExploitee TINYINT(1) DEFAULT 0 NOT NULL, estArchivee TINYINT(1) DEFAULT 0 NOT NULL, estDesactivee TINYINT(1) DEFAULT 0 NOT NULL, multimedia VARCHAR(255) DEFAULT NULL, idUtilisateur INT NOT NULL, idCategorie INT NOT NULL, INDEX IDX_6A2CD5C75D419CCB (idUtilisateur), INDEX IDX_6A2CD5C7B597FD62 (idCategorie), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, motDePasse VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, estDesactive TINYINT(1) DEFAULT 0 NOT NULL, photo VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE enregistrer ADD CONSTRAINT FK_94548385D419CCB FOREIGN KEY (idUtilisateur) REFERENCES utilisateurs (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE groupesRessources ADD CONSTRAINT FK_9B81C0086F756E12 FOREIGN KEY (idRessource) REFERENCES ressources (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE groupesRessources ADD CONSTRAINT FK_9B81C00867A824BB FOREIGN KEY (idGroupe) REFERENCES groupes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE groupesUtilisateurs ADD CONSTRAINT FK_68C4EF995D419CCB FOREIGN KEY (idUtilisateur) REFERENCES utilisateurs (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE groupesUtilisateurs ADD CONSTRAINT FK_68C4EF9967A824BB FOREIGN KEY (idGroupe) REFERENCES groupes (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE participer ADD CONSTRAINT FK_EDBE16F85D419CCB FOREIGN KEY (idUtilisateur) REFERENCES utilisateurs (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE groupesRessources DROP FOREIGN KEY FK_9B81C0086F756E12');
        $this->addSql('ALTER TABLE groupesRessources DROP FOREIGN KEY FK_9B81C00867A824BB');
        $this->addSql('ALTER TABLE groupesUtilisateurs DROP FOREIGN KEY FK_68C4EF995D419CCB');
        $this->addSql('ALTER TABLE groupesUtilisateurs DROP FOREIGN KEY FK_68C4EF9967A824BB');
        ...
        $this->addSql('DROP TABLE groupesRessources');
        $this->addSql('DROP TABLE groupesUtilisateurs');
