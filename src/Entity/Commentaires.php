...
class Commentaires
{
    ...
    #[ORM\Column(type: Types::DATETIME_MUTABLE, name: "dateCreationCommentaire")]
    ...
    {
        if ($this->commentaires->removeElement($commentaire) && $commentaire->getIdCommentaireParent() === $this) {
